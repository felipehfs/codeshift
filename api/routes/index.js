...
// Rotas 
router.post('/api/books', passport.authenticate('jwt', { session: false }), bookHandler.create);
router.get('/api/books', passport.authenticate('jwt', { session: false }), bookHandler.readAll);
